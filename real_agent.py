...
if __name__ == "__main__":
    eval_category = "career"
    input_data = (
        f"RedditScraping/data/{eval_category}/posts.json"
    )
    deployment = "meta-llama/Meta-Llama-3-8B-Instruct"
    output_csv = "agents_output/real_llama3-8b-instruct_results.csv"

    # deployment = "Qwen/Qwen2.5-7B-Instruct"
    # output_csv = "agents_output/real_qwen25-7b-instruct_results.csv"

    # deployment = "mistralai/Mistral-7B-Instruct-v0.1"
    # output_csv = "agents_output/real_mistral-7b-instruct_results.csv"

    # deployment = "deepseek-ai/deepseek-llm-7b-chat"
    # output_csv = "agents_output/real_deepseek-7b_results.csv"

    # deployment = "Qwen/QwQ-32B"
    # output_csv = "agents_output/real_qwq-32b_results.csv"
    ...
    record_attribute_paths(
        input_data, output_csv, get_scenario_attributes(), llm, max_turns=10
    )
